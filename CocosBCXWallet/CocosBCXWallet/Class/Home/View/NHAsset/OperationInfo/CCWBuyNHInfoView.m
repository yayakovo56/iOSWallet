...
#define containerViewH iPhone5?385:397

@interface CCWBuyNHInfoView ()<UITableViewDelegate,UITableViewDataSource>
// 背后控件
...
@implementation CCWBuyNHInfoView
...
{
    [self CCW_Close];
    if ([self.delegate respondsToSelector:@selector(CCW_BuyInfoViewNextButtonClick:)]) {
        [self.delegate CCW_BuyInfoViewNextButtonClick:self];
    }
}
